...
# (str) Extra xml to write directly inside the <manifest><application> tag of Andrandroid.permissions = INTERNET,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,CAMERAoidManifest.xml
